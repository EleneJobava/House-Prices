...
### ექსპერიმენტი 9 Decision Tree Overfit 
...
### ექსპერიმენტი 10 Decision Tree Underfit
...
### ექსპერიმენტი 10 Decision Tree Tuned
ამ ექსპერიმენტში გამოვიყენე max_depth=5, რათა მეპოვა ოქროს შუალედი წინა ორ უკიდურესობას (Overfitting და Underfitting) შორის. შედეგები აჩვენებს, რომ მოდელი ბევრად უფრო სტაბილურია: Train RMSE 22,412 ხოლო 
Test RMSE 26,831 განსხვავება სატრენინგო და სატესტო ცდომილებებს შორის მცირეა, რაც იმას ნიშნავს, რომ მოდელი აღარ "იზეპირებს" მონაცემებს (როგორც max_depth=None-ზე) და აღარც ზედმეტად ზოგადია (როგორც max_depth=2-ზე). R^2-ის მაჩვენებელი გაუმჯობესდა 79%-მდე. ეს არის საუკეთესო შედეგი, რისი მიღწევაც ერთი Decision Tree-ით არის შესაძლებელი ამ მონაცემებზე. თუმცა, Ridge რეგრესიის შედეგებთან შედარებით (R^2=0.92), ეს მოდელი მაინც სუსტია. შედეგების კიდევ უფრო გასაუმჯობესებლად საჭიროა ანსამბლური მოდელების გამოყენება (მაგალითად, Random Forest ან XGBoost), რომლებიც ბევრი ასეთი ხის კომბინაციით ამცირებენ ცდომილებას.
